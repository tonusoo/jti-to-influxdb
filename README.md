...
Small script for lab usage which reads [Junos Telemetry Interface native sensors](https://www.juniper.net/documentation/en_US/junos/topics/concept/junos-telemetry-interface-export-format-understanding.html)(JTI) data and writes results to InfluxDB time series database.
